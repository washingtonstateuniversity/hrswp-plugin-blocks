...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/lib/filter.js");
/******/ })
/************************************************************************/
/******/ ({
...
var Filter = /*#__PURE__*/function () {
  ...
  function Filter(content) {
    ...
    this._markInstance = new mark_js__WEBPACK_IMPORTED_MODULE_2___default.a(this._content);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Filter, [{
    key: "find",
    value: function find() {
      var instance = this._markInstance;
      var keyword = this._searchInput.value;
      var content = this._content;
      /**
       * @type {NodeList} All nodes with the class 'show' assigned by a previous filter.
       */

      var previousMatches = content.querySelectorAll('.show');
      var currentMatches = [];
      /**
      ...
      var options = {
         ...
         */
        filter: function filter(node, term) {
          /**
    ...
    key: "_handleURLSearchParams",
    value: function _handleURLSearchParams() {
...
function init() {
  var searchForms =
  /** @type {NodeList} */
  document.querySelectorAll('.wp-block-hrswp-search-filter');
